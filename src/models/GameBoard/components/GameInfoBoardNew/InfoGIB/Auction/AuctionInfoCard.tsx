				...
				<ContainerInfoTwoColumnGIB>
					...
					>
						<InnerBtnContextSpaceBetween>
								...
								<>
									{amountHouses > 1
										...
										: <Button
											...
											style={{ width: '22px', marginRight: '10px' }}
										>-</Button>}
									С {cardInfo?.features?.house_taxes && getPriceTaxesFromHouses(amountHouses, cardInfo?.features?.house_taxes)?.name}
									{
							...
							<Text
								text={cardInfo?.features?.house_taxes && getPriceTaxesFromHouses(amountHouses, cardInfo?.features?.house_taxes)?.price + ''}
								iconRight={<Icon src={icons.qgCurrencySvg} width={'15px'} />}
							/>
						</InnerBtnContextSpaceBetween>
					</Button>
