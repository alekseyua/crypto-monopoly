...
const ActionsCard: React.FC<IProps> = ({
  ...
  return (
    <ContainerGIB>
      ...
      <ContainerInfoGIB
        style={{
          backgroundColor: adjustColorBrightness(card?.owner?.player?.color || '#F5F5F5', 70),
        }}
      >
        ...
        <ContainerInfoBodyGIB>
          ...
          <ContainerOneBtn>
            <ButtonBack
              onClick={() => handleChangeScreen('info-card')}
          ...
          <ContainerInfoTwoColumnGIB>
            <Button
              type='fill'
              fillColor={adjustColorBrightness(card?.owner?.player?.color || '#F5F5F5', 90)}
              p={10}
        ...
        <ContainerInfoFooterGIB
          style={{
            backgroundColor: adjustColorBrightness(card?.owner?.player?.color || '#F5F5F5', 40),
          }}
        >
