...
export const GameInfoBoardActionsExchange: React.FC<IGameInfoBoardActionsExchangeProps> = ({
	...
	}, [listUserExchange, userForExchange]);
	...
	}, [stateExchange.propertys_from, cards]);
				...
				<div className={styles['gib__btns-container']}>
					<div className={styles['gib__btns-container--btn-two']}>
						...
						<Button
							...
							Отказ ({<AutoCounter disabled={false} counter={30} callback={() => { }} />})
						</Button>
					</div>
				</div>
				<Offset mb={10} />
								...
								<div className={styles['gib__body-desc-container--two-section']}>
									...
									<div className={styles['gib__user-exchange--input-container']}>
										...
										<Input
											...
											value={stateExchange.price_from === 0 ? '' : stateExchange.price_from}
											...
											iconLeft={isSetInputPriceFrom? <Icon
												className={styles['gib__user-exchange--input-currency']}
												width='15px'
												height='15px'
												src={icons.qgCurrencySvg}
											/> : undefined}
											iconRight={!!stateExchange.price_from && !isSetInputPriceFrom ?
												<Icon 
													className={styles['gib__user-exchange--input-success']}
									...
									<div className={styles['gib__user-exchange--input-container']}>
										{
											...
											<>
												...
												<Input
													wrapClassName={styles['gib__user-exchange--input-container-input']}
													placeholder='Введите сумму...'
													value={stateExchange.price_to === 0 ? '' : stateExchange.price_to}
													...
													iconLeft={isSetInputPriceTo ? <Icon
														className={styles['gib__user-exchange--input-currency']}
														width='15px'
														height='15px'
														src={icons.qgCurrencySvg}
													/> : undefined}
													iconRight={!!stateExchange.price_to && !isSetInputPriceTo ?
														<Icon
															className={styles['gib__user-exchange--input-success']}
															src={icons.checkMarkerWhite}
															width='12px'
