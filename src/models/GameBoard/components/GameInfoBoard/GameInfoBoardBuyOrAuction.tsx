				...
				<div className={styles['gib__header-container']}>
					...
					<div className={styles['gib__btns-container--btn-two']}>
						...
						<Button
							...
							onClick={handleAuction} type='outline'>Автоотказ {<AutoCounter disabled={isActionCard} counter={timeEndMove} callback={handleAuction} />
							}</Button>
					</div>
					<Offset mt={10} />
				</div>
							...
							<div className={styles['gib__info-card-info-desc-container']}>
								<InfoBoardLabel>
									<div className={styles['gib__info-card-info-desc-label']}>
										<p>Налог</p>
										<p>{dataCard.features?.one_card_tax}<Icon
											width='15px'
											height='15px'
											ml={3}
											src={icons.qgCurrencySvg}
								...
								<InfoBoardLabel>
									<div className={styles['gib__info-card-info-desc-label']}>
										<p>С коллекцией</p>
										<p>{dataCard.features?.monopoly_tax}<Icon
											width='15px'
											height='15px'
											ml={3}
											src={icons.qgCurrencySvg}
