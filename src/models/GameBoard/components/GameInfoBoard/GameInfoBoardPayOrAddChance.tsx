							...
							<div className={styles['gib__info-card-info-desc-container']}>
								<InfoBoardLabel>
									<div className={styles['gib__info-card-info-desc-label']}>
										<p>Налог</p>
										<p>{dataCard.features?.one_card_tax}<Icon className={styles['gib__currency']} src={currency2White} /></p>
									</div>
								</InfoBoardLabel>
								<InfoBoardLabel>
									<div className={styles['gib__info-card-info-desc-label']}>
								...
								<InfoBoardLabel>
									<div className={styles['gib__info-card-info-desc-label']}>
										<p>С коллекцией</p>
										<p>{dataCard.features?.monopoly_tax}<Icon className={styles['gib__currency']} src={currency2White} /></p>
									</div>
								</InfoBoardLabel>
								<InfoBoardLabel>
									<div className={styles['gib__info-card-info-desc-label']}>
