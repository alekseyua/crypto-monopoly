    ...
    return (
        ...
        >
            ...
            <div className={cls['field__round-container']}>
                <Button className={cls['field__btn-round']} variant='gradient' onClick={() => { }}>{name}</Button>
                <strong className={cls['field__btn-round-title']}>+ {cardCost} $</strong>
