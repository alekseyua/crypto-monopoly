...
import { HANDLER_SEARCH_CHANGE, IRule } from "./rule.type.d";
import { IState } from "..";


export const rule = (store: StoreonStore<IState>) => {
    const initDataRules:IRule[] = [
    {
        id: 1,
        title: 'Игрок',
        rule:
    ...
    store.on(HANDLER_SEARCH_CHANGE, (state: IState, searchText: string) => {
